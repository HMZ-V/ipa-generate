...
final List<District> mockDistricts = [
  const District(
    ...
    name: 'Downtown Core',
    emoji: '🏙️',
    imagePath: 'assets/prop-burj.jpg',
    control: 34,
  ...
  const District(
    ...
    name: 'Marina Bay',
    emoji: '⛵',
    imagePath: 'assets/prop-marina.jpg',
    control: 22,
  ...
  const District(
    ...
    name: 'Palm Heights',
    emoji: '🌴',
    imagePath: 'assets/prop-palm.jpg',
    control: 12,
  ...
  const District(
    ...
    name: 'Business Bay',
    emoji: '🏢',
    imagePath: 'assets/prop-office.jpg',
    control: 56,
    topAlliance: 'Gulf Titans',
    demand: DemandLevel.high,
    status: DistrictStatus.rising,
  ...
  const District(
    ...
    emoji: '🕌',
    imagePath: 'assets/prop-creek.jpg',
    control: 8,
  ...
  const District(
    ...
    name: 'Desert Edge',
    emoji: '🏜️',
    imagePath: 'assets/prop-desert.jpg',
    control: 0,
    topAlliance: '—',
